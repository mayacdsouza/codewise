...
const Surveys = () => {
  ...
  const handleCandidateInput = async (e) => {
    try {
      await fetch("https://access.engr.oregonstate.edu:3378/add_candidate", {
        method: "POST",
        headers: {
    ...
    const fetchCandidates = async () => {
      try {
        const response = await fetch(
          "https://access.engr.oregonstate.edu:3378/select_candidates"
        );
  ...
  useEffect(() => {
    const handleSendToCandidate = async (
      ...
      try {
        ...
        const response = await fetch(
          "https://access.engr.oregonstate.edu:3378/add_result",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
